          ...
          contents: [{
            ...
            parts: [{
              text: `
                ...
                [필수 검색 지침]
                1. 최신 웹 검색 결과를 바탕으로 해당 주류의 국내 실거래 시세, 온/오프라인 전문 주류점(와인숍, 리쿼샵) 공지 가격, 주류 커뮤니티 및 블로그의 실제 내돈내산 구매 후기 가격을 종합하여 시세를 파악하세요.
                2. 특정 사이트에만 국한하지 말고, 국내 웹 전체에서 언급되는 실거래 가격 데이터를 폭넓게 참고해야 정확한 시세가 도출됩니다. (특히 와인/위스키는 온라인 택배 판매가 제한되므로 로컬 와인숍 공지나 블로그 검색이 필수적입니다.)
                3. 가격 정보는 사용자가 직관적으로 참고할 수 있도록 소비자가 실제로 마트나 매장에서 구매하는 대략적인 가격대 범위(예: 450,000원 ~ 550,000원 부근) 형태로 유연하게 포맷팅해 주세요.
                4. 국내 웹 전체를 정밀 검색했음에도 해당 주류에 대한 명확한 거래 흔적이나 가격 언급을 도저히 찾을 수 없는 경우에만, 허위 정보를 지어내지 말고 가격 필드에 "정보없음"이라고 기입하세요.
